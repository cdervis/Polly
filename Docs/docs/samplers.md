...
[Drawing sprites](sprites.md) shows how the destination rectangle is able to scale a sprite, disregarding its image size.
This is thanks to image interpolation, which is controllable via `#!cpp Painter::setSampler()`.
...
![img](../assets/images/samplers-upscaled.webp){.align-center width=300}
...
![img](../assets/images/samplers-pixelated.webp){.align-center width=300}
